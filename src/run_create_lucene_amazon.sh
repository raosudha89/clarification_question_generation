...
rm -r $DATA_DIR/${SITENAME}/prod_docs/
rm -r $DATA_DIR/${SITENAME}/ques_docs/
mkdir -p $DATA_DIR/${SITENAME}/prod_docs/
mkdir -p $DATA_DIR/${SITENAME}/ques_docs/
...
python $SCRIPT_DIR/create_lucene_amazon.py 	--qa_data_fname $DATA_DIR/qa_${SITENAME}.json.gz \
											...
											--product_dir $DATA_DIR/${SITENAME}/prod_docs/ \
											--question_dir $DATA_DIR/${SITENAME}/ques_docs/
