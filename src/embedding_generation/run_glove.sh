...
#SBATCH --qos=dque
#SBATCH --job-name=glove_Home_and_Kitchen
#SBATCH --output=glove_Home_and_Kitchen
#SBATCH --mem=32g
#SBATCH --time=48:00:00 

SITENAME=Home_and_Kitchen
DATADIR=/fs/clip-scratch/raosudha/clarification_question_generation/data/embeddings/$SITENAME

CORPUS=/fs/clip-scratch/raosudha/clarification_question_generation/data/amazon/$SITENAME/datadump.txt
...
BUILDDIR=/fs/clip-software/user-supported/GloVe-1.2/build
