...
def main(args):
    ...
    writer.writerow(['asin', 'title', 'description', 'q1_model', 'q1', 'q2_model', 'q2', 'q3_model', 'q3'])
    all_rows = []
    for asin in descriptions:
      ...
      writer.writerow([asin, title, description, 'gold', gold_question, 'lucene', lucene_question, 'simcandqs', simcandqs_question])
