...
on_topic_scores = {'gold':{}, 'lucene':{}, 'simcandqs':{}}
is_specific_scores = {'gold':{}, 'lucene':{}, 'simcandqs':{}}
new_info_scores = {'gold':{}, 'lucene':{}, 'simcandqs':{}}
customer_support_scores = {'gold':{}, 'lucene':{}, 'simcandqs':{}}
useful_to_another_buyer_scores = {'gold':{}, 'lucene':{}, 'simcandqs':{}}

on_topic_scores_list = {'gold':[], 'lucene':[], 'simcandqs':[]}
is_specific_scores_list = {'gold':[], 'lucene':[], 'simcandqs':[]}
new_info_scores_list = {'gold':[], 'lucene':[], 'simcandqs':[]}
customer_support_scores_list = {'gold':[], 'lucene':[], 'simcandqs':[]}
useful_to_another_buyer_scores_list = {'gold':[], 'lucene':[], 'simcandqs':[]}
...
def main(args):
    ...
    with open(args.aggregate_results) as csvfile:
        ...
        for row in reader:
            ...
            if ques_model == 'lucene':
                if float(row['on_topic:confidence']) < 0.6:
                    on_topic = 'Strongly Disagree'
                if float(row['is_specific:confidence']) < 0.6:
                    is_specific = 'Strongly Disagree'
                if float(row['useful_to_another_buyer:confidence']) < 0.6:
                    useful_to_another_buyer = 'Strongly Disagree'
            
            #if on_topic == 'Strongly Disagree':
            #    new_info = 'No'
            #    useful_to_another_buyer = 'Strongly Disagree'
            #if new_info == 'No':
            #    useful_to_another_buyer = 'Strongly Disagree'
    ...
    for asin in on_topic_scores['gold'].keys():
