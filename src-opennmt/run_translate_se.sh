...
#SBATCH --job-name=translate_onlycontext_aus
#SBATCH --output=translate_onlycontext_aus
...
#python $OPENNMT/translate.py	-model $OPENNMT_DATA/opennmt_model_${TRAIN_SUFFIX}_${TEST_SUFFIX}_copy_coverage_acc_*_e20.pt \
#							 	-src $CQ_DATA_DIR/test_src_${TEST_SUFFIX}.txt \
#								-output $CQ_DATA_DIR/test_pred_${TRAIN_SUFFIX}_${TEST_SUFFIX}_copy_coverage.txt \
#								-replace_unk \
#								#-gpu 0 \
#
